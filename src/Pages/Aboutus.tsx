    ...
    <div className="bg-gray-100 min-h-screen">
      <header className="bg-gradient-to-r from-blue-600 to-teal-500 text-white shadow-md py-6">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold">TravelScout</h1>
          <nav>
          ...
          <section className="bg-white bg-opacity-95 text-gray-800 py-12 rounded-lg shadow-lg">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <section className="md:w-1/2 px-4 mb-8 md:mb-0">
                <h3 className="text-3xl font-bold mb-4 text-blue-600">TravelScout</h3>
                <h4 className="text-xl text-teal-500 font-semibold mb-4">
                  Contact Us: 913-686-5327 | Email: support@travelscout.com
                </h4>
                <p className="leading-relaxed mb-6">
                  At TravelScout, we're passionate about making your travel dreams a reality. We’re your one-stop shop for all your travel needs, offering a wide range of hotel and flight booking options to destinations around the globe.
                </p>
                ...
                <h3 className="text-2xl font-semibold mt-6 mb-3 text-blue-500">Why Choose TravelScout?</h3>
                <ul className="list-disc list-inside space-y-3 text-gray-700">
                ...
                <p className="leading-relaxed mt-6">
                  Whether you're planning a romantic getaway, a family vacation, or a business trip, TravelScout is your trusted partner. Book your next adventure with us today!
                </p>
              </section>
